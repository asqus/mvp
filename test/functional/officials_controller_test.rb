...
class OfficialsControllerTest < ActionController::TestCase
  ...
  test "should create official" do
    assert_difference('Official.count') do
      post :create, official: { district_id: @official.district_id, name: @official.name, position: @official.position }
    end
  ...
  test "should update official" do
    put :update, id: @official, official: { district_id: @official.district_id, name: @official.name, position: @official.position }
    assert_redirected_to official_path(assigns(:official))
  end
